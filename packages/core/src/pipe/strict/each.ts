import type { IterableReturnValue, UniversalIterable, UniversalIterableItem } from '@/types'
 ...
 * ```
 *
 * {@link https://github.com/niuiic/fx-flow/blob/main/packages/test/src/pipe/strict/each.spec.ts | More examples}
 */
