import type { FlatReturnValue, IteratorResolve, Reject, UniversalIterable } from '@/types'
import { IterableTypeException, empty, isAsyncIterable, isIterable } from '@/utils'
 ...
 * ```
 *
 * {@link https://github.com/niuiic/fx-flow/blob/main/packages/test/src/pipe/lazy/flat.spec.ts | More examples}
 */
