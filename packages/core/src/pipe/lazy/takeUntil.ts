import type { IteratorReturnValue, MaybePromise, UniversalIterable, UniversalIterableItem } from '@/types'
 ...
 * ```
 *
 * {@link https://github.com/niuiic/fx-flow/blob/main/packages/test/src/pipe/lazy/takeUntil.spec.ts | More examples}
 */
