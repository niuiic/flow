...
import { IterableTypeException, call, isAsyncIterable, isIterable } from 'src/utils.js'
 ...
 * ```
 *
 * {@link https://github.com/niuiic/flow/blob/main/tests/pipe/strict/reduce.spec.ts | More examples}
 */
// no item
